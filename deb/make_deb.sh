...
#sudo chmod 644 sysadmws-utils/opt/sysadmws-utils/rsnapshot_backup/*
#sudo chmod 600 sysadmws-utils/opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf.sample
#sudo chmod 600 sysadmws-utils/opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf.localhost
...
#sudo chmod 600 sysadmws-utils/opt/sysadmws-utils/logrotate_db_backup/logrotate_db_backup.conf.sample
...
#sudo chmod 644 sysadmws-utils/opt/sysadmws-utils/grains.template
