...
sed "s/HOSTNAME/$HN/g" /opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf.localhost | grep CENTOS > /opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf
...
cat /opt/sysadmws-utils/salt/grains.centos.template | sed "s/HOSTNAME/$HN/g" >> /etc/salt/grains
