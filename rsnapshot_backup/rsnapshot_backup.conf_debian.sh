...
sed "s/HOSTNAME/$HN/g" /opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf.localhost | grep DEBIAN > /opt/sysadmws-utils/rsnapshot_backup/rsnapshot_backup.conf
...
cat /opt/sysadmws-utils/salt/grains.debian.template | sed "s/HOSTNAME/$HN/g" >> /etc/salt/grains
